...
int elf_recog(struct file *, objfmt_t, char **);
int elf_load(struct file *, objfmt_t, char *);
...
int
elf_recog(struct file *fp, objfmt_t ofmt, char **hdr)
{
...
int
elf_load(struct file *fp, objfmt_t ofmt, char *hdr)
{
