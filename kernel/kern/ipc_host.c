 ...
 *	Purpose:
 *		Convert from a port (really ipc_port_t) to a host.
...
host_t
convert_port_to_host_priv(name)
	mach_port_t name;
{
	ipc_port_t port = (ipc_port_t) name;
	host_t host = HOST_NULL;
 ...
 *	Purpose:
 *		Convert from a port (really ipc_port_t) to a processor.
...
processor_t
convert_port_to_processor(name)
	mach_port_t name;
{
	ipc_port_t port = (ipc_port_t) name;
 ...
 *	Purpose:
 *		Convert from a port (really ipc_port_t) to a pset.
...
processor_set_t
convert_port_to_pset_name(name)
	mach_port_t name;
{
	ipc_port_t port = (ipc_port_t) name;
	processor_set_t pset = PROCESSOR_SET_NULL;
 ...
 *	Purpose:
 *		Convert from a host to a port (really ipc_port_t).
 ...
 *	Purpose:
 *		Convert from a processor to a port (really ipc_port_t).
 *		Produces a naked send right which may be invalid.
 *	Conditions:
 *		Nothing locked.
 */
 ...
 *	Purpose:
 *		Convert from a pset to a port (really ipc_port_t).
