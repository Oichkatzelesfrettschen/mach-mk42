 ...
 * Descriptors 0x08..0x38 are reserved for the bootstrap loader.
 */
#define	KERNEL_CS	0x40		/* kernel code */
#define	KERNEL_DS	0x48		/* kernel data */
#define	KERNEL_LDT	0x50		/* master LDT */
#define	KERNEL_TSS	0x58		/* master TSS (uniprocessor) */
