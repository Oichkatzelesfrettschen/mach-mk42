...
LEAF(check_fpa)
	...
	cfc1	v0,fpa_csr
	nop
	sw	v0,MSS_SIZE+MMS_FPA_CSR(a3)
	cfc1	v0,fpa_eir
	nop
	sw	v0,MSS_SIZE+MMS_FPA_EIR(a3)
...
genexc:
	...
	jal	spl0			# lower priority, disable fpa
...
/*
 *	Object:
 *		splsoftclock			EXPORTED function
 *
...
/*
 *	Object:
 *		splbio				EXPORTED function
 *		spl6				EXPORTED function alias
 *
 ...
 *
 *	Returns the previous content of the status register
 *	The spl6 alias is for historical reasons
 */
LEAF(splbio)
XLEAF(spl6)
	mfc0	v0,c0_status
...
/*
 *	Object:
 *		spltty				EXPORTED function
 *		spl5				EXPORTED function alias
 *
 ...
 *
 *	Returns the previous content of the status register
 *	The spl5 alias is for historical reasons
 */
LEAF(spltty)
XLEAF(spl5)
	mfc0	v0,c0_status
...
/*
 *	Object:
 *		splhigh				EXPORTED function
 *		splsched			EXPORTED function
 *
 ...
 *	is provided to modify appropriately the IPL for the splxxx()
