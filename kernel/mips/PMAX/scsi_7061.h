...
typedef struct {
	...
	short						pad19;
	volatile unsigned short	sii_command;	/* rw: command register */
	short						pad20;
...
#define	SII_PHASE(dtr)		((dtr)&0x7)
#define	SII_PHASE_DATAO		0x0
#define	SII_PHASE_DATAI		0x1
#define	SII_PHASE_CMD		0x2
#define	SII_PHASE_STATUS	0x3
#define	SII_PHASE_MSG_OUT	0x6
#define	SII_PHASE_MSG_IN	0x7
