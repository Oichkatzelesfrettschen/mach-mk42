...
#define mipsbox_intr6(ss,cs,st,spl)		(*pmax_intr6)((st),(spl))
#define mipsbox_intr5(ss,cs,st,spl)		(*pmax_intr5)((st),(spl))
#define mipsbox_intr4(ss,cs,st,spl)		(*pmax_intr4)((st),(spl))
#define mipsbox_intr3(ss,cs,st,spl)		(*pmax_intr3)((st),(spl))
#define mipsbox_intr2(ss,cs,st,spl)		(*pmax_intr2)((st),(spl))
