...
#	define SCSI_CMD_FMT_DEFECT		0x10
#	define SCSI_CMD_FMT_LIST		0x08
...
typedef struct {
	...
	unsigned char	mbz1:4,		/* special DEC hack, all reserved */
			buffer_mode:3,
			reserved2:1;
...
typedef union {
    struct {
	unsigned char	scsi_status_vendor_uqe1:1,
			scsi_status_code:4,
