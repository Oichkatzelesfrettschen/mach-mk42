...
#if	UseStaticMsgType
	static mach_msg_type_t backupType = {
...
#else	UseStaticMsgType
	InP->backupType.msgt_name = MACH_MSG_TYPE_MAKE_SEND;
	InP->backupType.msgt_size = 32;
	InP->backupType.msgt_number = 1;
	InP->backupType.msgt_inline = TRUE;
	InP->backupType.msgt_longform = FALSE;
	InP->backupType.msgt_deallocate = FALSE;
	InP->backupType.msgt_unused = 0;
#endif	UseStaticMsgType
