...
#endif
{
...
#if	UseStaticMsgType
	static mach_msg_type_t my_portType = {
...
#if	UseStaticMsgType
	static mach_msg_type_t his_nameType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
	...
	InP->my_portType.msgt_name = MACH_MSG_TYPE_MOVE_RECEIVE;
	InP->my_portType.msgt_size = 32;
	InP->my_portType.msgt_number = 1;
	InP->my_portType.msgt_inline = TRUE;
	InP->my_portType.msgt_longform = FALSE;
	InP->my_portType.msgt_deallocate = FALSE;
	InP->my_portType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#else	UseStaticMsgType
	InP->his_nameType.msgt_name = 2;
	InP->his_nameType.msgt_size = 32;
	InP->his_nameType.msgt_number = 1;
	InP->his_nameType.msgt_inline = TRUE;
	InP->his_nameType.msgt_longform = FALSE;
	InP->his_nameType.msgt_deallocate = FALSE;
	InP->his_nameType.msgt_unused = 0;
#endif	UseStaticMsgType
