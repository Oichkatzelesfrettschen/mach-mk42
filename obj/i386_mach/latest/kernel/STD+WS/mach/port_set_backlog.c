...
#else	UseStaticMsgType
	InP->backlogType.msgt_name = 2;
	InP->backlogType.msgt_size = 32;
	InP->backlogType.msgt_number = 1;
	InP->backlogType.msgt_inline = TRUE;
	InP->backlogType.msgt_longform = FALSE;
	InP->backlogType.msgt_deallocate = FALSE;
	InP->backlogType.msgt_unused = 0;
#endif	UseStaticMsgType
