...
#endif
{
...
#if	TypeCheck
	if ((OutP->processor_listType.msgtl_header.msgt_inline != FALSE) ||
	...
	*processor_listCnt /* processor_listType.msgtl_number */ = /* *processor_listCnt */ OutP->processor_listType.msgtl_number;
...
#if	TypeCheck
	if ((OutP->host_info_outType.msgtl_header.msgt_inline != TRUE) ||
...
#if	TypeCheck
	msgh_size_delta = (4 * OutP->host_info_outType.msgtl_number);
	if (msgh_size != 44 + msgh_size_delta)
		return MIG_TYPE_ERROR;
#endif	TypeCheck

	if (OutP->host_info_outType.msgtl_number / 1 > *host_info_outCnt) {
		bcopy((char *) OutP->host_info_out, (char *) host_info_out, 4 * *host_info_outCnt);
		*host_info_outCnt /* host_info_outType.msgtl_number 1 */ = /* *host_info_outCnt */ OutP->host_info_outType.msgtl_number / 1;
		return MIG_ARRAY_TOO_LARGE;
	}
	bcopy((char *) OutP->host_info_out, (char *) host_info_out, 4 * OutP->host_info_outType.msgtl_number);

	*host_info_outCnt /* host_info_outType.msgtl_number */ = /* *host_info_outCnt */ OutP->host_info_outType.msgtl_number;
...
#endif
{
...
#if	UseStaticMsgType
	static mach_msg_type_t hostCheck = {
	...
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(MACH_MSG_TYPE_COPY_SEND, MACH_MSG_TYPE_MAKE_SEND_ONCE);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = processor;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_kind = MACH_MSGH_KIND_NORMAL | MSG_TYPE_RPC;
	InP->Head.msgh_id = 2602;
...
#else	UseStaticMsgType
	if ((OutP->hostType.msgt_inline != TRUE) ||
...
#if	TypeCheck
	if ((OutP->processor_info_outType.msgtl_header.msgt_inline != TRUE) ||
...
#if	TypeCheck
	msgh_size_delta = (4 * OutP->processor_info_outType.msgtl_number);
	if (msgh_size != 52 + msgh_size_delta)
		return MIG_TYPE_ERROR;
#endif	TypeCheck

	if (OutP->processor_info_outType.msgtl_number / 1 > *processor_info_outCnt) {
		bcopy((char *) OutP->processor_info_out, (char *) processor_info_out, 4 * *processor_info_outCnt);
		*processor_info_outCnt /* processor_info_outType.msgtl_number 1 */ = /* *processor_info_outCnt */ OutP->processor_info_outType.msgtl_number / 1;
		return MIG_ARRAY_TOO_LARGE;
	}
	bcopy((char *) OutP->processor_info_out, (char *) processor_info_out, 4 * OutP->processor_info_outType.msgtl_number);

	*processor_info_outCnt /* processor_info_outType.msgtl_number */ = /* *processor_info_outCnt */ OutP->processor_info_outType.msgtl_number;
...
#endif
{
...
#if	UseStaticMsgType
	static mach_msg_type_long_t processor_cmdType = {
	{
		/* msgt_name = */		0,
		/* msgt_size = */		0,
		/* msgt_number = */		0,
...
#else	UseStaticMsgType
	InP->processor_cmdType.msgtl_name = 2;
	InP->processor_cmdType.msgtl_size = 32;
	InP->processor_cmdType.msgtl_header.msgt_name = 0;
	InP->processor_cmdType.msgtl_header.msgt_size = 0;
	InP->processor_cmdType.msgtl_header.msgt_number = 0;
	InP->processor_cmdType.msgtl_header.msgt_inline = TRUE;
	InP->processor_cmdType.msgtl_header.msgt_longform = TRUE;
	InP->processor_cmdType.msgtl_header.msgt_deallocate = FALSE;
	InP->processor_cmdType.msgtl_header.msgt_unused = 0;
#endif	UseStaticMsgType
	...
	InP->processor_cmdType.msgtl_number /* processor_cmdCnt */ = /* processor_cmdType.msgtl_number */ processor_cmdCnt;

	msgh_size_delta = (4 * processor_cmdCnt);
...
#if	UseStaticMsgType
	static mach_msg_type_t default_setCheck = {
		/* msgt_name = */		MACH_MSG_TYPE_PORT_SEND,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	if ((OutP->default_setType.msgt_inline != TRUE) ||
...
#if	UseStaticMsgType
	static mach_msg_type_t new_setCheck = {
		/* msgt_name = */		MACH_MSG_TYPE_PORT_SEND,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	if ((OutP->new_setType.msgt_inline != TRUE) ||
...
#else	UseStaticMsgType
	if ((OutP->new_nameType.msgt_inline != TRUE) ||
...
#endif
{
	...
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(MACH_MSG_TYPE_COPY_SEND, MACH_MSG_TYPE_MAKE_SEND_ONCE);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = set;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_kind = MACH_MSGH_KIND_NORMAL | MSG_TYPE_RPC;
	InP->Head.msgh_id = 2609;
...
#endif
{
	...
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(MACH_MSG_TYPE_COPY_SEND, MACH_MSG_TYPE_MAKE_SEND_ONCE);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = set_name;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_kind = MACH_MSGH_KIND_NORMAL | MSG_TYPE_RPC;
	InP->Head.msgh_id = 2610;
...
#if	TypeCheck
	if ((OutP->info_outType.msgtl_header.msgt_inline != TRUE) ||
...
#if	TypeCheck
	msgh_size_delta = (4 * OutP->info_outType.msgtl_number);
	if (msgh_size != 52 + msgh_size_delta)
		return MIG_TYPE_ERROR;
#endif	TypeCheck

	if (OutP->info_outType.msgtl_number / 1 > *info_outCnt) {
		bcopy((char *) OutP->info_out, (char *) info_out, 4 * *info_outCnt);
		*info_outCnt /* info_outType.msgtl_number 1 */ = /* *info_outCnt */ OutP->info_outType.msgtl_number / 1;
		return MIG_ARRAY_TOO_LARGE;
	}
	bcopy((char *) OutP->info_out, (char *) info_out, 4 * OutP->info_outType.msgtl_number);

	*info_outCnt /* info_outType.msgtl_number */ = /* *info_outCnt */ OutP->info_outType.msgtl_number;
...
#else	UseStaticMsgType
	InP->new_setType.msgt_name = MACH_MSG_TYPE_COPY_SEND;
	InP->new_setType.msgt_size = 32;
	InP->new_setType.msgt_number = 1;
	InP->new_setType.msgt_inline = TRUE;
	InP->new_setType.msgt_longform = FALSE;
	InP->new_setType.msgt_deallocate = FALSE;
	InP->new_setType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#if	UseStaticMsgType
	static mach_msg_type_t assigned_setCheck = {
		/* msgt_name = */		MACH_MSG_TYPE_PORT_SEND,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	if ((OutP->assigned_setType.msgt_inline != TRUE) ||
...
#if	UseStaticMsgType
	static mach_msg_type_t assign_threadsType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	InP->assign_threadsType.msgt_name = 0;
	InP->assign_threadsType.msgt_size = 32;
	InP->assign_threadsType.msgt_number = 1;
	InP->assign_threadsType.msgt_inline = TRUE;
	InP->assign_threadsType.msgt_longform = FALSE;
	InP->assign_threadsType.msgt_deallocate = FALSE;
	InP->assign_threadsType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#endif
{
	...
	if (OutP->Head.msgh_id != 2719)
		return MIG_REPLY_MISMATCH;

#if	TypeCheck
	if (((msgh_size != 556) || !msgh_simple) &&
	    ((msgh_size != sizeof(mig_reply_header_t)) ||
	     !msgh_simple ||
	     (OutP->RetCode == KERN_SUCCESS)))
		return MIG_TYPE_ERROR;
...
#if	UseStaticMsgType
	static mach_msg_type_t set_maxType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	InP->set_maxType.msgt_name = 0;
	InP->set_maxType.msgt_size = 32;
	InP->set_maxType.msgt_number = 1;
	InP->set_maxType.msgt_inline = TRUE;
	InP->set_maxType.msgt_longform = FALSE;
	InP->set_maxType.msgt_deallocate = FALSE;
	InP->set_maxType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#if	UseStaticMsgType
	static mach_msg_type_t processor_setType = {
		/* msgt_name = */		MACH_MSG_TYPE_COPY_SEND,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#if	UseStaticMsgType
	static mach_msg_type_t max_priorityType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	InP->processor_setType.msgt_name = MACH_MSG_TYPE_COPY_SEND;
	InP->processor_setType.msgt_size = 32;
	InP->processor_setType.msgt_number = 1;
	InP->processor_setType.msgt_inline = TRUE;
	InP->processor_setType.msgt_longform = FALSE;
	InP->processor_setType.msgt_deallocate = FALSE;
	InP->processor_setType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#else	UseStaticMsgType
	InP->max_priorityType.msgt_name = 2;
	InP->max_priorityType.msgt_size = 32;
	InP->max_priorityType.msgt_number = 1;
	InP->max_priorityType.msgt_inline = TRUE;
	InP->max_priorityType.msgt_longform = FALSE;
	InP->max_priorityType.msgt_deallocate = FALSE;
	InP->max_priorityType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#if	UseStaticMsgType
	static mach_msg_type_t change_threadsType = {
		/* msgt_name = */		0,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	InP->change_threadsType.msgt_name = 0;
	InP->change_threadsType.msgt_size = 32;
	InP->change_threadsType.msgt_number = 1;
	InP->change_threadsType.msgt_inline = TRUE;
	InP->change_threadsType.msgt_longform = FALSE;
	InP->change_threadsType.msgt_deallocate = FALSE;
	InP->change_threadsType.msgt_unused = 0;
#endif	UseStaticMsgType
...
#endif
{
	...
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(MACH_MSG_TYPE_COPY_SEND, MACH_MSG_TYPE_MAKE_SEND_ONCE);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = processor_set;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_kind = MACH_MSGH_KIND_NORMAL | MSG_TYPE_RPC;
	InP->Head.msgh_id = 2623;
...
#endif
{
...
#if	TypeCheck
	if ((OutP->task_listType.msgtl_header.msgt_inline != FALSE) ||
	...
	*task_listCnt /* task_listType.msgtl_number */ = /* *task_listCnt */ OutP->task_listType.msgtl_number;
...
#endif
{
...
#if	TypeCheck
	if ((OutP->processor_setsType.msgtl_header.msgt_inline != FALSE) ||
	...
	*processor_setsCnt /* processor_setsType.msgtl_number */ = /* *processor_setsCnt */ OutP->processor_setsType.msgtl_number;
...
#if	UseStaticMsgType
	static mach_msg_type_t setCheck = {
		/* msgt_name = */		MACH_MSG_TYPE_PORT_SEND,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#else	UseStaticMsgType
	InP->set_nameType.msgt_name = MACH_MSG_TYPE_COPY_SEND;
...
#else	UseStaticMsgType
	if ((OutP->setType.msgt_inline != TRUE) ||
...
#if	UseStaticMsgType
	static mach_msg_type_t new_timeType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		2,
		/* msgt_inline = */		TRUE,
...
#if	UseStaticMsgType
	InP->new_timeType = new_timeType;
#else	UseStaticMsgType
	InP->new_timeType.msgt_name = 2;
	InP->new_timeType.msgt_size = 32;
	InP->new_timeType.msgt_number = 2;
	InP->new_timeType.msgt_inline = TRUE;
	InP->new_timeType.msgt_longform = FALSE;
	InP->new_timeType.msgt_deallocate = FALSE;
	InP->new_timeType.msgt_unused = 0;
#endif	UseStaticMsgType

	InP->new_time /* new_time */ = /* new_time */ new_time;
...
#endif
{
...
#if	UseStaticMsgType
	static mach_msg_type_t new_adjustmentType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		2,
		/* msgt_inline = */		TRUE,
...
#if	UseStaticMsgType
	static mach_msg_type_t old_adjustmentCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		2,
		/* msgt_inline = */		TRUE,
...
#if	UseStaticMsgType
	InP->new_adjustmentType = new_adjustmentType;
#else	UseStaticMsgType
	InP->new_adjustmentType.msgt_name = 2;
	InP->new_adjustmentType.msgt_size = 32;
	InP->new_adjustmentType.msgt_number = 2;
	InP->new_adjustmentType.msgt_inline = TRUE;
	InP->new_adjustmentType.msgt_longform = FALSE;
	InP->new_adjustmentType.msgt_deallocate = FALSE;
	InP->new_adjustmentType.msgt_unused = 0;
#endif	UseStaticMsgType

	InP->new_adjustment /* new_adjustment */ = /* new_adjustment */ new_adjustment;
...
#if	TypeCheck
#if	UseStaticMsgType
	if (* (int *) &OutP->old_adjustmentType != * (int *) &old_adjustmentCheck)
#else	UseStaticMsgType
	if ((OutP->old_adjustmentType.msgt_inline != TRUE) ||
	...
	*old_adjustment /* old_adjustment */ = /* *old_adjustment */ OutP->old_adjustment;
...
#endif
{
...
#if	UseStaticMsgType
	static mach_msg_type_t current_timeCheck = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		2,
		/* msgt_inline = */		TRUE,
...
#if	TypeCheck
#if	UseStaticMsgType
	if (* (int *) &OutP->current_timeType != * (int *) &current_timeCheck)
#else	UseStaticMsgType
	if ((OutP->current_timeType.msgt_inline != TRUE) ||
	...
	*current_time /* current_time */ = /* *current_time */ OutP->current_time;
...
#if	UseStaticMsgType
	static mach_msg_type_t optionsType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
#if	UseStaticMsgType
	InP->optionsType = optionsType;
#else	UseStaticMsgType
	InP->optionsType.msgt_name = 2;
	InP->optionsType.msgt_size = 32;
	InP->optionsType.msgt_number = 1;
	InP->optionsType.msgt_inline = TRUE;
	InP->optionsType.msgt_longform = FALSE;
	InP->optionsType.msgt_deallocate = FALSE;
	InP->optionsType.msgt_unused = 0;
#endif	UseStaticMsgType

	InP->options /* options */ = /* options */ options;
